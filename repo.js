 ...
 */
 (function($){
    ...
    $.fn.repo = function( options ){
        ...
        // var numstars = 0;
        // $.ajax({
        //         url: 'https://api.github.com/repos/' + _this.settings.user + '/' + _this.settings.name,
        //         type: 'GET',
        //         data: {},
        //         dataType: 'jsonp',
        //         success: function(response){
        //             numstars = response.data.stargazers_count;
        //         },
        //         error: function(response){
        //             if(console && console.log)
        //                 console.log('Request Error:', e);
